 ...
 * {@link com.creativeinfoway.smartstops.app.android.navigation.v5.navigation.NavigationRoute}.
 * </p><p>
 * For testing, you can launch with simulation, in which our
 * {@link com.creativeinfoway.smartstops.app.android.navigation.v5.location.replay.ReplayRouteLocationEngine} will begin
...
public class NavigationLauncher {
     ...
     */
    public static void startNavigation(Activity activity, NavigationLauncherOptions options, ArrayList<GetAllSubCategoryWaypoint.DataBean> allwaypoint, ArrayList<GetAllSubCategoryWaypoint.DataBean> allAPiWaypoint) {
...
//        navigationActivity.putParcelableArrayListExtra("allwaypoint", allwaypoint);
        navigationActivity.putParcelableArrayListExtra("allAPiWaypoint", allAPiWaypoint);
