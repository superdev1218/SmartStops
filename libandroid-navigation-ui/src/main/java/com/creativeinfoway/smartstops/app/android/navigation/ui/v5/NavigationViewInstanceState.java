...
public class NavigationViewInstanceState implements Parcelable {
  ...
  public NavigationViewInstanceState(int bottomSheetBehaviorState, int recenterButtonVisibility,
  ...
  public int getRecenterButtonVisibility() {
