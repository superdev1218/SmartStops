...
public class SmartStopsPrefLanguage {

    private SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public SmartStopsPrefLanguage(Context appContext) {
...
//
//    float xx=(width * imageOverlay.getX())/(float) viewOverlay.getWidth();
//  float yy=(height * imageOverlay.getY())/(float) viewOverlay.getHeight();
//
//  <Object>();
//
