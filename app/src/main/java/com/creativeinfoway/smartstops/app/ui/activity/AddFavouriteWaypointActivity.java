...
public class AddFavouriteWaypointActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_favourite_waypoint);

        smartStopsPref = new SmartStopsPref(this);

        txtError = findViewById(R.id.txtError);
        autoTvCountry = findViewById(R.id.auto_tv_select_country);
        imgeback = findViewById(R.id.iv_back);
        imgeback.setOnClickListener(this);
        autoTvProvince = findViewById(R.id.auto_tv_select_prince);
        autoTvPostal = findViewById(R.id.auto_tv_select_postal);
        autoTvwaypointCat = findViewById(R.id.auto_tv_select_waypoint_cat);
        autoTvwaypointSubCat = findViewById(R.id.auto_tv_select_waypoint_sub_cat);
        mEtName = findViewById(R.id.frag_add_fav_way_et_waypointname);
        mEtAddress = findViewById(R.id.frag_add_fav_way_et_address);
        mEtEmail = findViewById(R.id.frag_add_fav_way_et_email);
        mEtPhone = findViewById(R.id.frag_add_fav_way_et_phone);
        btnSubmit = findViewById(R.id.frag_add_fav_way_btn_submit);
...
//        userid = smartStopsPref.getString(Constant.USERID);
        ...
        waypointCatAdapater = new ArrayAdapter<String>(this, R.layout.custom_spinner_layout, waypointCatlist);
        ...
        subCatAdapter = new ArrayAdapter<String>(this, R.layout.custom_spinner_layout, waypointSubCatlist);
        autoTvwaypointSubCat.setAdapter(subCatAdapter);

        provinceAdapter = new ArrayAdapter<String>(this, R.layout.custom_spinner_layout, provinceList);
        autoTvProvince.setAdapter(provinceAdapter);

        postalAdapter = new ArrayAdapter<String>(this, R.layout.custom_spinner_layout, postallist);
...
//            intent.setAction(Intent.ACTION_GET_CONTENT);
    ...
    private void initCountrySpinner() {
        ...
        countrylist.add("US");
        ArrayAdapter<String> countryAdapter = new ArrayAdapter<String>(this, R.layout.custom_spinner_layout, countrylist);
                    ...
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        try {
                            ...
                            if (getPostalCode.getStatus().equals("1")) {
                                ...
                                Toast.makeText(AddFavouriteWaypointActivity.this, "" + getPostalCode.getMsg(), Toast.LENGTH_SHORT).show();
                            }
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
            ...
            call.enqueue(new Callback<ResponseBody>() {
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    ...
                    try {
                        ...
                        if (status.equals("1")) {
                            Toast.makeText(AddFavouriteWaypointActivity.this, String.valueOf(jsonObject.getString("msg")), Toast.LENGTH_SHORT).show();
                           ...
                           /* Fragment fragment = new FavouriteWayPointFragment();
                            ...
                            Intent intent = new Intent(AddFavouriteWaypointActivity.this,FavouriteWayPointActivity.class);
                            startActivity(intent);
                            finish();

                        } else {
                            Toast.makeText(AddFavouriteWaypointActivity.this, "" + jsonObject.optString("msg"), Toast.LENGTH_SHORT).show();
                        }
                ...
                @Override
                public void onFailure(Call<ResponseBody> call, Throwable t) {
                    Toast.makeText(AddFavouriteWaypointActivity.this, "" + t.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
    ...
    private boolean checkValidation() {
        if (mEtName.getText().toString().isEmpty()) {
            Toast.makeText(AddFavouriteWaypointActivity.this, "Please Enter Waypoint Name", Toast.LENGTH_SHORT).show();
            return false;
        } else if (mEtAddress.getText().toString().isEmpty()) {
            Toast.makeText(AddFavouriteWaypointActivity.this, "Please Enter Address", Toast.LENGTH_SHORT).show();
            return false;
        }  else if (autoTvCountry.getText().toString().compareTo("Select Country")==0) {
            Toast.makeText(AddFavouriteWaypointActivity.this, "Please Select Country", Toast.LENGTH_SHORT).show();
            return false;
        } else if (autoTvProvince.getText().toString().compareTo("Select Province")==0 ) {
            Toast.makeText(AddFavouriteWaypointActivity.this, "Please Select Province", Toast.LENGTH_SHORT).show();
            return false;
        } else if (autoTvPostal.getText().toString().compareTo("Select Postal Code")==0 ) {
            Toast.makeText(AddFavouriteWaypointActivity.this, "Please Select Postal Code", Toast.LENGTH_SHORT).show();
            return false;
        } else if (autoTvwaypointCat.getText().toString().compareTo("Select Waypoint Category")==0) {
            Toast.makeText(AddFavouriteWaypointActivity.this, "Please Select Waypoint Category", Toast.LENGTH_SHORT).show();
            return false;
        } else if (autoTvwaypointSubCat.getText().toString().isEmpty()) {
            Toast.makeText(AddFavouriteWaypointActivity.this, "Please Select Waypoint Sub-Category", Toast.LENGTH_SHORT).show();
            return false;
        } else if (files[0] == null) {
            Toast.makeText(AddFavouriteWaypointActivity.this, "Please Select at-least one Image ", Toast.LENGTH_SHORT).show();
            return false;
        } else {
            return true;
        }
