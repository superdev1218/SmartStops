package com.creativeinfoway.smartstops.app.test;
...
import com.creativeinfoway.smartstops.app.android.navigation.ui.v5.NavigationView;
import com.creativeinfoway.smartstops.app.android.navigation.ui.v5.NavigationViewOptions;
import com.creativeinfoway.smartstops.app.android.navigation.ui.v5.OnNavigationReadyCallback;
...
public class TestNavigationActivity extends AppCompatActivity implements NavigationListener,
  ...
  public void onNavigationReady(boolean isRunning) {
    if (isRunning) {
      ...
      if (route != null) {
        ///navigationView.startNavigation(buildTestNavigationViewOptions(route), allwaypoint, this);
      }
    }
  }
